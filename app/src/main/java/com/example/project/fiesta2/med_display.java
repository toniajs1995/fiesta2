...
public class med_display extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                DataSnapshot snap=snapshot.child("media");
                ...
                adapter= new DisplayAdapter(companies,getApplicationContext(),"media");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(med_display.this,review.class);
        ...
        if (id == R.id.action_settings1) {
            Intent intent = new Intent(med_display.this,rating.class);
            intent.putExtra("key",key);
            //  Toast.makeText(company_display.this, key, Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        ...
        if (id == R.id.action_settings2) {
            Intent intent = new Intent(med_display.this,bookmark.class);
            // intent.putExtra("key",key);
            //  Toast.makeText(company_display.this, key, Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        ...
        if (id == R.id.action_settings3) {
            Intent intent = new Intent(med_display.this,event_date.class);
            intent.putExtra("key",key);
            //Toast.makeText(company_display.this, key, Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
